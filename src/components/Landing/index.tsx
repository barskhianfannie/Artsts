...
import { QueryDune, statusDune } from "../../utils/dune";
...
export const Landing = () => {
  ...
  return (
    <div
      style={{  background: "rgba(0,0,0,0.2)", minHeight: "100vh",paddingTop:'100px' }}
    >
      ...
      >
        ...
        >
          ...
          >
            {!duneQ ?  'Run Query' : executionId ? 'Query Results Fetched' : 'Running Query.....'}
          </button>
        </div>
        ...
        {executionId &&
        <DuneResults executionId={executionId}/>
}
      </div>
